module.exports = {
	...
	execute(msg) {
        ...
        const devembed = {
            ...
            '\n(해당 문서는 2021년 12년 30일에 업데이트되었습니다.) ',
            fields: [
                {
                    name: '텍스트 게임',
                ...
                {
                    name: '버튼 기능',
                    value: 'discord.js v13에 추가된 새로운 기능, 버튼 기능으로 기존의 이모지로 사용했던 상호작용 기능을 대체할 예정입니다. 노래봇과 타로봇 기능에 더 좋은 경험을 할 수 있게 할 것이라고 기대하고 있습니다.',
                    inline: false,
                },
                {
                    name: '밸런스 게임',
