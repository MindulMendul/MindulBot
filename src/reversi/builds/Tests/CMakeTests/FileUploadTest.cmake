file(REMOVE_RECURSE "C:/Users/leesj/Desktop/DiscordBot/src/reversi/Tests/CMakeTests/uploads")

if(EXISTS "C:/Users/leesj/Desktop/DiscordBot/src/reversi/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "C:/Users/leesj/Desktop/DiscordBot/src/reversi/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "C:/Users/leesj/Desktop/DiscordBot/src/reversi/Tests/CMakeTests/uploads")
...
if(NOT "C:/Users/leesj/Desktop/DiscordBot/src/reversi/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}C:/Users/leesj/Desktop/DiscordBot/src/reversi/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "C:/Users/leesj/Desktop/DiscordBot/src/reversi/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "C:/Users/leesj/Desktop/DiscordBot/src/reversi/Tests/CMakeTests/uploads/file2.png"
